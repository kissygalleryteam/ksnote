 ...
 * @module ksnote
 **/
KISSY.add('kg/ksnote/2.0.0/index',function (S, Node, Base, DD, Proxy, Storage) {
    var $ = Node.all,
        D = S.DOM,
        Drag = DD.Draggable;
    ...
    requires:['node', 'base', 'dd', 'dd/plugin/proxy', 'kg/storage/2.0.0/index']
});
